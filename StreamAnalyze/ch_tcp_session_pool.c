...
ch_tcp_session_t * 
ch_tcp_session_pool_entry_create(ch_tcp_session_pool_t *tspt,ch_tcp_session_request_t *sreq,
	...
	do{
		...
		if(ch_tcp_session_init(tcp_session,sreq,tspt->mm,tcp_pkt->pkt->timestamp)){
